...
heroImage: '../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-01.png'
...
![](../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-01.png)

xcode를 실행하고 왼쪽 상단의 프로젝트명을 오른쪽 클릭하여 `Add Files to "project_name"`을 클릭한다.

![](../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-02.png)

방금 생성한 `ios/Fonts`를 선택하고 아래와 같은 옵션으로 `Add` 버튼을 누른다.

![](../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-03.png)
...
![](../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-04.png)

그래서 구글링을 하여 추가로 진행한 작업이 `Build Phases`의 `Copy Bundle Resources`에 폰트 파일을 추가하는 것이다.

![](../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-05.png)
...
![](../../../../../assets/posts/React-Native-폰트-적용하기/React-Native-font-06.png)
