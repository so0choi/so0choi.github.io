...
4. 크롤러를 생성한다. Data Store로 데이터가 저장된 S3 버킷을 선택한다.
   ...
   ![](./2020-12-02-12-24-10.png)

   ![](./2020-12-02-12-25-20.png)

5. 앞서 만든 Role을 선택한다.
   ![](./2020-12-02-12-26-12.png)
6. 크롤러 출력 구성에서 `데이터베이스 추가`를 선택한다.
7. 구성을 확인하고 만들기를 완료한다.
8. 생성된 크롤러를 실행한다.

![](./2020-12-02-14-06-19.png)

크롤러의 동작시간과 수행결과가 출력된다.

![](./2020-12-02-14-11-15.png)

데이터 카탈로그에 새로 생성된 데이터베이스 내부에 테이블들이 생성된 것을 볼 수 있다.

![](./2020-12-02-14-15-31.png)
...
- DataSource Schema
  ![](./2020-12-02-14-47-36.png)

- DataTarget Schema
  ![](./2020-12-02-14-48-05.png)

- job 수행 결과

![](./2020-12-02-14-49-08.png)

S3에 결과 데이터가 저장되어있다.

![](./2020-12-02-14-49-35.png)
